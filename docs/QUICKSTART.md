...
| `HALO_LOG_DIR` | Agent / tool-server log directory | `/home/user/.halo/logs` |
| `HALO_CACHE_DIR` | Negative-experience cache location | `/home/user/GEMMA-by-GOOGLE` |
| `HALO_HTTPX_BIN` | Path to the `httpx` binary | `/home/user/go/bin/httpx` |
| `HALO_SHERLOCK_BIN` | Path to the `sherlock` binary | `/home/user/.local/bin/sherlock` |
